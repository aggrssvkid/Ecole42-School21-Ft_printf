...
/*   Updated: 2021/11/03 19:26:51 by enoye            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*zapolnim(char *str, unsigned long long int n, int size)
{
	char	*digits;
	char	*zapolnitel;
...
static int	getsize_sixteen(unsigned long long int n)
{
	int	size;
